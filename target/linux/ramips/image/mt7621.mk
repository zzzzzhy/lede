...
define Build/hitosea_wr1800k-factory
...
define Device/hitosea_wr1800k-ax-nand
  $(Device/dsa-migration)
  $(Device/uimage-lzma-loader)
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  ...
  KERNEL_INITRAMFS := $$(KERNEL) | hitosea_wr1800k-factory $(KDIR)/tmp/$$(KERNEL_INITRAMFS_PREFIX)-factory.bin
  DEVICE_VENDOR := Hitosea
  DEVICE_MODEL := WR1800K-AX
  DEVICE_VARIANT := NAND
  DEVICE_PACKAGES := kmod-mt7915e
endef
TARGET_DEVICES += hitosea_wr1800k-ax-nand